...
// Last update Tue Jan 12 18:11:00 2016 stephanedarcy simomba
//
...
void		promote(Borg::Starfleet::Captain *captain)
{
  std::cout << captain->getName() << ": I’m glad to be the captain of the USS " << this->_name << "." << endl;
}

Federation::Starfleet::Ensign::Ensign(std::string name) : _name(name)
{
  std::cout << "Ensign " << this->_name << ", awaiting orders." << endl;
}
