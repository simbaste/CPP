...
// Last update Thu Jan 14 09:02:05 2016 stephanedarcy simomba
//
...
{
  if (this->Id == droid.Id && this->Energy == droid.Energy && this->Attack == droid.Attack && this->Toughness == droid.Toughness && *(this->Status) == *(droid.Status))
    return (true);
  return (false);
}
